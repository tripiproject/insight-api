...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.tripid.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    istrc20Transfer: transaction.istrc20Transfer,
  };
...
TxController.prototype.transformTripiTransaction = function(transaction) {
